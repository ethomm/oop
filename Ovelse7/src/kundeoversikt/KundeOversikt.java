...
public class KundeOversikt implements Serializable{

	private static final long serialVersionUID = -1651333792665980991L;
	
	public static ArrayList<Kunde> kundeListe = new ArrayList<Kunde>();
