...
public class Gui extends JFrame {
	...
	private JList<Produkt> listeVarelager; 
	public JLabel printAntallFisk;
	public JLabel printAntallTotalt;
	public JLabel printAntallPattedyr;
	public JLabel printAntallReptiler;
	public JLabel printAntallAndreProdukter;
	...
	public Gui() {
		...
		VareLagerOversikt.setBounds(6, 5, 589, 512);
		...
		listeVarelager = new JList();
		listeVarelager.setBounds(6, 48, 306, 454);
		VareLagerOversikt.add(listeVarelager);
		
		JLabel lblTotaltAntallProdukter = new JLabel("Totalt antall produkter:");
		lblTotaltAntallProdukter.setBounds(324, 48, 200, 16);
		VareLagerOversikt.add(lblTotaltAntallProdukter);
		
		JLabel lblTotaltAntallPattedyr = new JLabel("Totalt antall pattedyr:");
		lblTotaltAntallPattedyr.setBounds(324, 71, 200, 16);
		VareLagerOversikt.add(lblTotaltAntallPattedyr);
		
		JLabel lblTotaltAntallReptiler = new JLabel("Totalt antall reptiler:");
		lblTotaltAntallReptiler.setBounds(324, 93, 200, 16);
		VareLagerOversikt.add(lblTotaltAntallReptiler);
		
		JLabel lblTotaltAntallFisk = new JLabel("Totalt antall fisk:");
		lblTotaltAntallFisk.setBounds(324, 115, 200, 16);
		VareLagerOversikt.add(lblTotaltAntallFisk);
		
		JLabel lblTotaltAntallAndre = new JLabel("Totalt antall andre produkter:");
		lblTotaltAntallAndre.setBounds(324, 137, 200, 16);
		VareLagerOversikt.add(lblTotaltAntallAndre);
		
		printAntallTotalt = new JLabel("");
		printAntallTotalt.setBounds(530, 48, 56, 16);
		VareLagerOversikt.add(printAntallTotalt);
		
		printAntallPattedyr = new JLabel("");
		printAntallPattedyr.setBounds(530, 71, 56, 16);
		VareLagerOversikt.add(printAntallPattedyr);
		
		printAntallReptiler = new JLabel("");
		printAntallReptiler.setBounds(530, 93, 56, 16);
		VareLagerOversikt.add(printAntallReptiler);
		
		printAntallFisk = new JLabel("");
		printAntallFisk.setBounds(530, 115, 56, 16);
		VareLagerOversikt.add(printAntallFisk);
		
		printAntallAndreProdukter = new JLabel("");
		printAntallAndreProdukter.setBounds(530, 137, 56, 16);
		VareLagerOversikt.add(printAntallAndreProdukter);
		
	}
	//Lager en lytter som sjekker om et objekt er valgt i listen
	public void addActionTilListeVarelager(ListSelectionListener ls){
		listeVarelager.addListSelectionListener(ls);
	}
	...
	public void setListeVarelager(DefaultListModel<Produkt> model) {
		this.listeVarelager.setModel(model);
	}
