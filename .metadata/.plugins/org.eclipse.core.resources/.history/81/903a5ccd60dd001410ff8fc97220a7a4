...
//Metoder for å håndtere data
	...
	private void hentVareListeOversikt() {
		...
		gui.printAntallPattedyr.setText(Integer.toString(VareLager.getAntallPattedyr()));
		//gui.printAntallAndreProdukter.setText(Integer.toString(VareLager.getAntallAndreProdukter()));
		gui.printAntallFisk.setText(Integer.toString(VareLager.getAntallFisk()));
		gui.printAntallReptiler.setText(Integer.toString(VareLager.getAntallReptiler()));
