	...
	public MainFrame() {
		...
		btnLeggTilLeverandr.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				updateLev();
				panLeverandor.setVisible(false);
				advarsel("Du har lagt til en ny Leverand퓊");
				tfLNavn.setText("");
				tfLEpost.setText("");
				tfLAdresse.setText("");
				tfLPostnr.setText("");
